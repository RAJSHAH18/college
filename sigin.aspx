<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sigin.aspx.cs" Inherits="college.sigin" %>
                ...
                <tr>
                    ...
                    <td class="auto-style2"><strong>:</strong></td>
                     <td>
                         ...
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="department" Display="Dynamic" ErrorMessage="* PLEASE SELECT DEPARTMENT" Font-Bold="True" ForeColor="Red" InitialValue="-1" SetFocusOnError="True" ValidationGroup="validate"></asp:RequiredFieldValidator>
                   </ContentTemplate>
                        </asp:UpdatePanel>
                         </td>
                </tr>
